package otus.microservice.architecture.lesson_6.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import otus.microservice.architecture.lesson_6.domain.dto.User;
import otus.microservice.architecture.lesson_6.domain.mapper.UserMapper;
import otus.microservice.architecture.lesson_6.domain.model.UserDomain;
import otus.microservice.architecture.lesson_6.domain.repository.UserRepository;
